...
| `image.tag`                      | MongoDB(&reg;) image tag (immutable tags are recommended)                                                                                                   | `7.0.2-debian-11-r0`   |
...
| `tls.image.tag`                  | Init container TLS certs setup image tag (immutable tags are recommended)                                                                                   | `1.25.2-debian-11-r40` |
...
| `externalAccess.autoDiscovery.image.tag`                      | Init container auto-discovery image tag (immutable tags are recommended)                                                                        | `1.28.2-debian-11-r8` |
...
| `metrics.image.tag`                          | MongoDB(&reg;) Prometheus exporter image tag (immutable tags are recommended)                                                 | `0.39.0-debian-11-r115`    |
